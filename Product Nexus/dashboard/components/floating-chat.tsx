    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-primary hover:bg-primary/90 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center z-50 group"
      ...
      {isOpen && (
        <div
          className={`fixed bottom-6 right-6 w-96 bg-[#1a1a1a] border border-white/10 rounded-lg shadow-2xl flex flex-col z-50 transition-all duration-300 ${
